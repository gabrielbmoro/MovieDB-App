...
description: Generate unit tests for code changed in the current branch vs main, following kotlin.test and hand-written fakes conventions
license: MIT
...
Generates unit tests for Kotlin files that differ between the current branch and `main`.
