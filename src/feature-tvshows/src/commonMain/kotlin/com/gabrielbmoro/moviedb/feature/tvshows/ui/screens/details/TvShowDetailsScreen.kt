...
import moviedbapp.feature_tvshows.generated.resources.details_tv_created_by
import moviedbapp.feature_tvshows.generated.resources.details_tv_episodes
import moviedbapp.feature_tvshows.generated.resources.details_tv_first_air_date
import moviedbapp.feature_tvshows.generated.resources.details_tv_homepage
import moviedbapp.feature_tvshows.generated.resources.details_tv_language
import moviedbapp.feature_tvshows.generated.resources.details_tv_last_air_date
import moviedbapp.feature_tvshows.generated.resources.details_tv_networks
import moviedbapp.feature_tvshows.generated.resources.details_tv_overview
import moviedbapp.feature_tvshows.generated.resources.details_tv_popularity
import moviedbapp.feature_tvshows.generated.resources.details_tv_poster
import moviedbapp.feature_tvshows.generated.resources.details_tv_production_companies
import moviedbapp.feature_tvshows.generated.resources.details_tv_retry
import moviedbapp.feature_tvshows.generated.resources.details_tv_seasons
import moviedbapp.feature_tvshows.generated.resources.details_tv_status
import moviedbapp.feature_tvshows.generated.resources.details_tv_tagline
...
private fun TvShowDetailsScreenError(
    ...
    Box(modifier = modifier) {
        Column(
            ...
            onRetry?.let {
                Button(onClick = it) {
                    Text(stringResource(Res.string.details_tv_retry))
                }
            }
        }
    }
...
private fun TvShowDetailsScreenContent(
    ...
    Column(
                ...
                uiState.showVideo && uiState.videoId != null -> {
                    ...
                    MovieImage(
                        ...
                        Modifier
                            .align(Alignment.TopCenter)
                            .fillMaxSize(),
                        contentDescription = stringResource(Res.string.details_tv_poster),
                    )
                }
            }
        }
        ...
        SectionTitle(
            title = stringResource(Res.string.details_tv_overview),
            modifier = Modifier.padding(horizontal = 16.dp),
        )
        SectionBody(
        ...
        SectionTitle(
            title = stringResource(Res.string.details_tv_first_air_date),
            modifier = Modifier.padding(horizontal = 16.dp),
        )
        SectionBody(
        ...
        if (uiState.lastAirDate != null) {
            SectionTitle(
                title = stringResource(Res.string.details_tv_last_air_date),
                modifier = Modifier.padding(horizontal = 16.dp),
            )
            SectionBody(
        ...
        if (uiState.status != null) {
            SectionTitle(
                title = stringResource(Res.string.details_tv_status),
                modifier = Modifier.padding(horizontal = 16.dp),
            )
            SectionBody(
                body = uiState.status,
        ...
        SectionTitle(
            title = stringResource(Res.string.details_tv_seasons),
            modifier = Modifier.padding(horizontal = 16.dp),
        )
        SectionBody(
        ...
        SectionTitle(
            title = stringResource(Res.string.details_tv_episodes),
            modifier = Modifier.padding(horizontal = 16.dp),
        )
        SectionBody(
        ...
        SectionTitle(
            title = stringResource(Res.string.details_tv_popularity),
            modifier = Modifier.padding(horizontal = 16.dp),
        )
        SectionBody(
        ...
        SectionTitle(
            title = stringResource(Res.string.details_tv_language),
            modifier = Modifier.padding(horizontal = 16.dp),
        )
        SectionBody(
        ...
        if (uiState.tagline != null) {
            SectionTitle(
                title = stringResource(Res.string.details_tv_tagline),
                modifier = Modifier.padding(horizontal = 16.dp),
            )
            SectionBody(
        ...
        if (uiState.networks.isNotEmpty()) {
            SectionTitle(
                title = stringResource(Res.string.details_tv_networks),
                modifier = Modifier.padding(horizontal = 16.dp),
            )
            SectionBody(
        ...
        if (uiState.createdBy.isNotEmpty()) {
            SectionTitle(
                title = stringResource(Res.string.details_tv_created_by),
                modifier = Modifier.padding(horizontal = 16.dp),
            )
            SectionBody(
        ...
        if (uiState.productionCompanies.isNotEmpty()) {
            SectionTitle(
                title = stringResource(Res.string.details_tv_production_companies),
                modifier = Modifier.padding(horizontal = 16.dp),
            )
            SectionBody(
        ...
        if (uiState.homepage != null) {
            SectionTitle(
                title = stringResource(Res.string.details_tv_homepage),
                modifier = Modifier.padding(horizontal = 16.dp),
            )
            TextUrl(
