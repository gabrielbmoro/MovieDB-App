...
class MovieMapperTest {
    ...
    fun `should be able to convert a response to movie object`() {
        ...
        Truth.assertThat(result.backdropImageUrl)
            .isEqualTo(MovieMapper.BIG_SIZE_IMAGE_ADDRESS.plus(movieResponse.backdropPath))
        Truth.assertThat(result.posterImageUrl)
            .isEqualTo(MovieMapper.SMALL_SIZE_IMAGE_ADDRESS.plus(movieResponse.posterPath))
